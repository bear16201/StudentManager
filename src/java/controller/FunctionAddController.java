...
public class FunctionAddController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./FunctionAdd.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (warring == 1) {
                ...
                dao.addFunction(team_name, function_name, feature_name, priority, access_role, description, complex, owner_name, status);
            }
        } catch (Exception ex) {
