<%-- 
    Document   : home
    Created on : May 31, 2022, 11:33:34 AM
    Author     : My PC
--%>
...
<html>
    <body>
        ...
        <div class="col-lg-12 d-flex flex-column" style="width: 100%; height: 88vh; background: rgba(0, 0, 0, .8);background-color: white">
            <img class="background-image" src="images/background.jpeg" style="filter:brightness(60%); height: 88vh; padding: 2px;">
        </div>
