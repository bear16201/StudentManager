            ...
            <div class="main-panel">
                ...
                <c:if test="${sessionScope.acc != null}">
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <form action="functiondetails" method="post" class="form-sample" id="register-form"> 
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">Function ID</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="group1" value="${d.id}" name="FuncID" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="group1" value="${d.function_name}" name="function_name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="team_name" class="group1">
                                                            <option value="${d.team_name}" style="display: none">${d.team_name}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="feature_name" class="group1">
                                                            <option value="${d.feature_name}" style="display: none">${d.feature_name}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="access_role" class="group1">
                                                            <option value="${d.access_role}" style="display: none">${d.access_role}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="owner_name" class="group1">
                                                            <option value="${d.owner_name}" style="display: none">${d.owner_name}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="group1" value="${d.priority}" name="priority">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
