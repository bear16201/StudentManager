                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex justify-content-between align-items-start">
                                            <div>
                                                <h1 class=" Title">Edit A Subject</h1>
                                            </div>
                                        </div>   
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><span class="btn-md col-lg-9" >
                                                                    <input type="text" class="btn btn-lg btn-rounded form-control" value="${details.subject_id}" style="height: 60px;text-align: start"
                                                                           name="subject_id"
                                                                           required 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><span class="btn-md col-lg-9" >
                                                                    <input type="text" class="btn btn-lg btn-rounded form-control" value="${details.subject_code}" style="height: 60px;text-align: start" 
                                                                           name="subject_code"
                                                                           required 
                                                                           pattern="[A-Za-z0-9]{3,8}"
                                                                           title="ID nhập vào cần trong khoảng từ 3 đến 8 ký tự chỉ sử dụng chữ và chữ số!"/>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><span class="btn-md col-lg-9" >
                                                                    <input type="text" class="btn btn-lg btn-rounded form-control" value="${details.subject_name}" style="height: 60px;text-align: start" 
                                                                           name="subject_name"
                                                                           required 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><span class="btn-md col-lg-9" >
                                                                    <input type="text" class="btn btn-lg btn-rounded form-control" value="${details.subject_author}" style="height: 60px;text-align: start" 
                                                                           name="subject_author"
                                                                           required 
                                                                           pattern="[A-Za-z0-9]{3,8}"
                                                                           title="ID nhập vào cần trong khoảng từ 3 đến 8 ký tự chỉ sử dụng chữ và chữ số!"/>
